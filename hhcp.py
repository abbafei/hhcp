...
def open_file_fd(di_file, is_writing=False):
    return (os.fdopen((sys.stdout if is_writing else sys.stdin).fileno(), ('wb' if is_writing else 'rb')) if (di_file is None) else open(di_file, ('ab' if is_writing else 'rb')))
